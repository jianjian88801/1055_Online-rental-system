<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="信誉值" prop="xinyuzhi">
          <el-input v-model="ruleForm.xinyuzhi" 
              placeholder="信誉值" clearable  :readonly="ro.xinyuzhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="信誉值" prop="xinyuzhi">
              <el-input v-model="ruleForm.xinyuzhi" 
                placeholder="信誉值" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shangjiamingcheng = true;
          ...
          if(o=='xinyuzhi'){
            this.ruleForm.xinyuzhi = obj[o];
	    this.ro.xinyuzhi = true;
            continue;
          }
          if(o=='yuezujiage'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/xinyuzhi/shangjiazhanghao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
    ...
    shangjiazhanghaoChange () {
      this.$http({
        url: `follow/xinyuzhi/shangjiazhanghao?columnValue=`+ this.ruleForm.shangjiazhanghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              ...
              if(data.data.xinyuzhi){
                this.ruleForm.xinyuzhi = data.data.xinyuzhi
              }
        } else {
          this.$message.error(data.msg);
        }
	...
	this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../springbootyf10w/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
